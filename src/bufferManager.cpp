...
/*
    This function is used to clear the bufferPool
    If there are updates to any matrix and the previously loaded page already resides in pool.
    Then it prints the unupdated version of the same.
    Thats why clearing the pool is necessary.
*/
