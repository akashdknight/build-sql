...
class Table
{
    ...
    void createTempPages(string one, string two);
    void sortPages(string, string);
...
public:
    ...
    void sortRelation(bool flag = true);  //if flag is true, sorting is permanent(exported), or else only valid in this session.
    void join();
    void order();
    void group();
